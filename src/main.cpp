...
auto usb = usb_host_serial::getInstance();
...
//    auto &userial(usb.userial);
//    auto &usbHost(usb.usbHost);
//
//    while(true){
//        if(SerialUSB.available()){
//            auto read = SerialUSB.read();
//            usb.userial.write(read);
//            SerialUSB.write(read);
//        }
//
//        if(usb.userial.available()){
//            auto read = usb.userial.read();
//            usb.userial.write(read);
//            SerialUSB.write(read);
//        }
//
//        //if(usb.userial.available()){
//        //    SerialUSB.write(usb.userial.read());
//        //}
//
//        //usb.userial.print("hi");
//        //SerialUSB.print("hithere");
//
//        usb.usbHost.Task();
//    }
//
...
void loop() {
    ...
    if (SerialUSB.available()) {
        usb.userial.write(SerialUSB.read());
    }
